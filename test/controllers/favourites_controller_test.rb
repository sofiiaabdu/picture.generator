...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { description: @favourite.description, url: @favourite.url } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { description: @favourite.description, url: @favourite.url } }
